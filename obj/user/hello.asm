...
umain(int argc, char **argv)
{
  ...
  800052:	c7 04 24 ae 11 80 00 	movl   $0x8011ae,(%esp)
...
libmain(int argc, char **argv)
{
  ...
  800072:	e8 8e 0d 00 00       	call   800e05 <sys_getenvid>
...
exit(void)
{
  ...
  8000bd:	e8 77 0d 00 00       	call   800e39 <sys_env_destroy>
}
  8000c2:	c9                   	leave  
  8000c3:	c3                   	ret    
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800100:	e8 ca 01 00 00       	call   8002cf <vprintfmt>
  ...
  800118:	e8 03 0a 00 00       	call   800b20 <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  80016c:	e8 af 09 00 00       	call   800b20 <sys_cputs>
		b->idx = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800263:	0f be 80 cf 11 80 00 	movsbl 0x8011cf(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800347:	ff 24 8d a0 12 80 00 	jmp    *0x8012a0(,%ecx,4)
  ...
  80042a:	c7 44 24 08 e9 11 80 	movl   $0x8011e9,0x8(%esp)
  800431:	00 
  ...
  800461:	bb ec 11 80 00       	mov    $0x8011ec,%ebx
				p = "(null)";
			if (width > 0 && padc != '-')
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800b68:	c7 04 24 28 14 80 00 	movl   $0x801428,(%esp)
  800b6f:	e8 b1 f5 ff ff       	call   800125 <cprintf>
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800b99:	00 
  800b9a:	c7 44 24 08 54 14 80 	movl   $0x801454,0x8(%esp)
  800ba1:	00 
  800ba2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ba9:	00 
  800baa:	c7 04 24 71 14 80 00 	movl   $0x801471,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800bf6:	00 
  800bf7:	c7 44 24 08 54 14 80 	movl   $0x801454,0x8(%esp)
  800bfe:	00 
  800bff:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c06:	00 
  800c07:	c7 04 24 71 14 80 00 	movl   $0x801471,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c8c:	00 
  800c8d:	c7 44 24 08 54 14 80 	movl   $0x801454,0x8(%esp)
  800c94:	00 
  800c95:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c9c:	00 
  800c9d:	c7 04 24 71 14 80 00 	movl   $0x801471,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cea:	00 
  800ceb:	c7 44 24 08 54 14 80 	movl   $0x801454,0x8(%esp)
  800cf2:	00 
  800cf3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cfa:	00 
  800cfb:	c7 04 24 71 14 80 00 	movl   $0x801471,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d48:	00 
  800d49:	c7 44 24 08 54 14 80 	movl   $0x801454,0x8(%esp)
  800d50:	00 
  800d51:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d58:	00 
  800d59:	c7 04 24 71 14 80 00 	movl   $0x801471,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800da7:	00 
  800da8:	c7 44 24 08 54 14 80 	movl   $0x801454,0x8(%esp)
  800daf:	00 
  800db0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800db7:	00 
  800db8:	c7 04 24 71 14 80 00 	movl   $0x801471,(%esp)
...
sys_env_destroy(envid_t envid)
{
  ...
  800e6c:	00 
  800e6d:	c7 44 24 08 54 14 80 	movl   $0x801454,0x8(%esp)
  800e74:	00 
  800e75:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e7c:	00 
  800e7d:	c7 04 24 71 14 80 00 	movl   $0x801471,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  800ef8:	c7 04 24 80 14 80 00 	movl   $0x801480,(%esp)
  800eff:	e8 21 f2 ff ff       	call   800125 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800f04:	89 74 24 04          	mov    %esi,0x4(%esp)
  800f08:	8b 45 10             	mov    0x10(%ebp),%eax
  800f0b:	89 04 24             	mov    %eax,(%esp)
  800f0e:	e8 b1 f1 ff ff       	call   8000c4 <vcprintf>
	cprintf("\n");
  800f13:	c7 04 24 ac 11 80 00 	movl   $0x8011ac,(%esp)
  800f1a:	e8 06 f2 ff ff       	call   800125 <cprintf>
