...
libmain(int argc, char **argv)
{
  ...
  800052:	e8 32 03 00 00       	call   800389 <sys_getenvid>
...
exit(void)
{
  ...
  80009d:	e8 1b 03 00 00       	call   8003bd <sys_env_destroy>
}
  8000a2:	c9                   	leave  
  8000a3:	c3                   	ret    
...
008000d7 <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8000da:	83 ec 38             	sub    $0x38,%esp
  8000dd:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8000e0:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8000e3:	89 7d fc             	mov    %edi,-0x4(%ebp)
	if (upcall==NULL) {
  8000e6:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
  8000ea:	75 0c                	jne    8000f8 <sys_env_set_pgfault_upcall+0x21>
		cprintf("lib sys_env_set_pgfault_up: upcall is NULL\n");
  8000ec:	c7 04 24 8c 11 80 00 	movl   $0x80118c,(%esp)
  8000f3:	e8 11 04 00 00       	call   800509 <cprintf>
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8000fd:	b8 09 00 00 00       	mov    $0x9,%eax
  800102:	8b 55 08             	mov    0x8(%ebp),%edx
  800105:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  800108:	89 df                	mov    %ebx,%edi
  80010a:	89 de                	mov    %ebx,%esi
  ...
  800110:	7e 28                	jle    80013a <sys_env_set_pgfault_upcall+0x63>
		panic("syscall %d returned %d (> 0)", num, ret);
  800112:	89 44 24 10          	mov    %eax,0x10(%esp)
  800116:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  80011d:	00 
  80011e:	c7 44 24 08 b8 11 80 	movl   $0x8011b8,0x8(%esp)
  800125:	00 
  800126:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80012d:	00 
  80012e:	c7 04 24 d5 11 80 00 	movl   $0x8011d5,(%esp)
  800135:	e8 16 03 00 00       	call   800450 <_panic>
{
	if (upcall==NULL) {
		cprintf("lib sys_env_set_pgfault_up: upcall is NULL\n");
	}
...
sys_ipc_recv(void *dstva)
{
  ...
  80015b:	b8 0c 00 00 00       	mov    $0xc,%eax
  ...
  80016d:	7e 28                	jle    800197 <sys_ipc_recv+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  80016f:	89 44 24 10          	mov    %eax,0x10(%esp)
  800173:	c7 44 24 0c 0c 00 00 	movl   $0xc,0xc(%esp)
  80017a:	00 
  80017b:	c7 44 24 08 b8 11 80 	movl   $0x8011b8,0x8(%esp)
  800182:	00 
  800183:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80018a:	00 
  80018b:	c7 04 24 d5 11 80 00 	movl   $0x8011d5,(%esp)
  800192:	e8 b9 02 00 00       	call   800450 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8001b1:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
	...
	asm volatile("int %1\n"
  8001b5:	be 00 00 00 00       	mov    $0x0,%esi
  8001ba:	b8 0b 00 00 00       	mov    $0xb,%eax
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8001cd:	8b 1c 24             	mov    (%esp),%ebx
  8001d0:	8b 74 24 04          	mov    0x4(%esp),%esi
  8001d4:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8001d8:	89 ec                	mov    %ebp,%esp
  8001da:	5d                   	pop    %ebp
  8001db:	c3                   	ret    

008001dc <sys_env_set_status>:
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8001f0:	b8 08 00 00 00       	mov    $0x8,%eax
  ...
  800203:	7e 28                	jle    80022d <sys_env_set_status+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  800205:	89 44 24 10          	mov    %eax,0x10(%esp)
  800209:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  800210:	00 
  800211:	c7 44 24 08 b8 11 80 	movl   $0x8011b8,0x8(%esp)
  800218:	00 
  800219:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800220:	00 
  800221:	c7 04 24 d5 11 80 00 	movl   $0x8011d5,(%esp)
  800228:	e8 23 02 00 00       	call   800450 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80022d:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800230:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800233:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800236:	89 ec                	mov    %ebp,%esp
  800238:	5d                   	pop    %ebp
  800239:	c3                   	ret    

0080023a <sys_page_unmap>:
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80023d:	83 ec 38             	sub    $0x38,%esp
  800240:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800243:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800246:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800261:	7e 28                	jle    80028b <sys_page_unmap+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  800263:	89 44 24 10          	mov    %eax,0x10(%esp)
  800267:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  80026e:	00 
  80026f:	c7 44 24 08 b8 11 80 	movl   $0x8011b8,0x8(%esp)
  800276:	00 
  800277:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80027e:	00 
  80027f:	c7 04 24 d5 11 80 00 	movl   $0x8011d5,(%esp)
  800286:	e8 c5 01 00 00       	call   800450 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80028b:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  80028e:	8b 75 f8             	mov    -0x8(%ebp),%esi
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80029b:	83 ec 38             	sub    $0x38,%esp
  80029e:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8002a1:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8002a4:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
	...
	asm volatile("int %1\n"
  8002a7:	b8 05 00 00 00       	mov    $0x5,%eax
  8002ac:	8b 75 18             	mov    0x18(%ebp),%esi
  8002af:	8b 7d 14             	mov    0x14(%ebp),%edi
  8002b2:	8b 5d 10             	mov    0x10(%ebp),%ebx
  ...
  8002bf:	7e 28                	jle    8002e9 <sys_page_map+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002c1:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002c5:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  8002cc:	00 
  8002cd:	c7 44 24 08 b8 11 80 	movl   $0x8011b8,0x8(%esp)
  8002d4:	00 
  8002d5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002dc:	00 
  8002dd:	c7 04 24 d5 11 80 00 	movl   $0x8011d5,(%esp)
  8002e4:	e8 67 01 00 00       	call   800450 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8002e9:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8002ec:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8002ef:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8002f2:	89 ec                	mov    %ebp,%esp
  8002f4:	5d                   	pop    %ebp
  8002f5:	c3                   	ret    

008002f6 <sys_page_alloc>:
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8002f9:	83 ec 38             	sub    $0x38,%esp
  8002fc:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8002ff:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800302:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  80031e:	7e 28                	jle    800348 <sys_page_alloc+0x52>
		panic("syscall %d returned %d (> 0)", num, ret);
  800320:	89 44 24 10          	mov    %eax,0x10(%esp)
  800324:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  80032b:	00 
  80032c:	c7 44 24 08 b8 11 80 	movl   $0x8011b8,0x8(%esp)
  800333:	00 
  800334:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80033b:	00 
  80033c:	c7 04 24 d5 11 80 00 	movl   $0x8011d5,(%esp)
...
sys_yield(void)
{
  ...
  80035e:	89 74 24 04          	mov    %esi,0x4(%esp)
  800362:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  80036b:	b8 0a 00 00 00       	mov    $0xa,%eax
  800370:	89 d1                	mov    %edx,%ecx
  800372:	89 d3                	mov    %edx,%ebx
  800374:	89 d7                	mov    %edx,%edi
...
sys_yield(void)
{
  ...
  80037a:	8b 1c 24             	mov    (%esp),%ebx
  80037d:	8b 74 24 04          	mov    0x4(%esp),%esi
  800381:	8b 7c 24 08          	mov    0x8(%esp),%edi
  800385:	89 ec                	mov    %ebp,%esp
  800387:	5d                   	pop    %ebp
  800388:	c3                   	ret    

00800389 <sys_getenvid>:
...
sys_getenvid(void)
{
  ...
  80038f:	89 1c 24             	mov    %ebx,(%esp)
  800392:	89 74 24 04          	mov    %esi,0x4(%esp)
  800396:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  80039f:	b8 02 00 00 00       	mov    $0x2,%eax
  8003a4:	89 d1                	mov    %edx,%ecx
  8003a6:	89 d3                	mov    %edx,%ebx
  8003a8:	89 d7                	mov    %edx,%edi
...
sys_getenvid(void)
{
  ...
  8003ae:	8b 1c 24             	mov    (%esp),%ebx
  8003b1:	8b 74 24 04          	mov    0x4(%esp),%esi
  8003b5:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8003b9:	89 ec                	mov    %ebp,%esp
  8003bb:	5d                   	pop    %ebp
  8003bc:	c3                   	ret    

008003bd <sys_env_destroy>:
...
sys_env_destroy(envid_t envid)
{
  ...
  8003d1:	b8 03 00 00 00       	mov    $0x3,%eax
  ...
  8003e3:	7e 28                	jle    80040d <sys_env_destroy+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003e5:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003e9:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  8003f0:	00 
  8003f1:	c7 44 24 08 b8 11 80 	movl   $0x8011b8,0x8(%esp)
  8003f8:	00 
  8003f9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800400:	00 
  800401:	c7 04 24 d5 11 80 00 	movl   $0x8011d5,(%esp)
  800408:	e8 43 00 00 00       	call   800450 <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  80040d:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800410:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800413:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800416:	89 ec                	mov    %ebp,%esp
  800418:	5d                   	pop    %ebp
  800419:	c3                   	ret    
...
sys_cgetc(void)
{
  ...
  800420:	89 1c 24             	mov    %ebx,(%esp)
  800423:	89 74 24 04          	mov    %esi,0x4(%esp)
  800427:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800435:	89 d1                	mov    %edx,%ecx
  800437:	89 d3                	mov    %edx,%ebx
...
sys_cgetc(void)
{
  ...
  80043f:	8b 1c 24             	mov    (%esp),%ebx
  800442:	8b 74 24 04          	mov    0x4(%esp),%esi
  800446:	8b 7c 24 08          	mov    0x8(%esp),%edi
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  800461:	e8 23 ff ff ff       	call   800389 <sys_getenvid>
  ...
  80047c:	c7 04 24 e4 11 80 00 	movl   $0x8011e4,(%esp)
  800483:	e8 81 00 00 00       	call   800509 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800488:	89 74 24 04          	mov    %esi,0x4(%esp)
  80048c:	8b 45 10             	mov    0x10(%ebp),%eax
  80048f:	89 04 24             	mov    %eax,(%esp)
  800492:	e8 11 00 00 00       	call   8004a8 <vcprintf>
	cprintf("\n");
  800497:	c7 04 24 08 12 80 00 	movl   $0x801208,(%esp)
  80049e:	e8 66 00 00 00       	call   800509 <cprintf>
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8004ab:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct printbuf b;

	b.idx = 0;
  8004b1:	c7 85 f0 fe ff ff 00 	movl   $0x0,-0x110(%ebp)
  8004b8:	00 00 00 
	b.cnt = 0;
  8004bb:	c7 85 f4 fe ff ff 00 	movl   $0x0,-0x10c(%ebp)
  8004c2:	00 00 00 
  ...
  8004dd:	c7 04 24 23 05 80 00 	movl   $0x800523,(%esp)
  8004e4:	e8 c6 01 00 00       	call   8006af <vprintfmt>
	sys_cputs(b.buf, b.idx);
  8004e9:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  8004ef:	89 44 24 04          	mov    %eax,0x4(%esp)
  8004f3:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  8004f9:	89 04 24             	mov    %eax,(%esp)
  8004fc:	e8 a3 fb ff ff       	call   8000a4 <sys_cputs>
  ...
  80050f:	8d 45 0c             	lea    0xc(%ebp),%eax
{
  ...
  80051c:	e8 87 ff ff ff       	call   8004a8 <vcprintf>
	va_end(ap);
...
putch(int ch, struct printbuf *b)
{
  ...
  800526:	53                   	push   %ebx
  800527:	83 ec 14             	sub    $0x14,%esp
  80052a:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	b->buf[b->idx++] = ch;
  80052d:	8b 03                	mov    (%ebx),%eax
  80052f:	8b 55 08             	mov    0x8(%ebp),%edx
  800532:	88 54 03 08          	mov    %dl,0x8(%ebx,%eax,1)
  800536:	83 c0 01             	add    $0x1,%eax
  800539:	89 03                	mov    %eax,(%ebx)
	if (b->idx == 256-1) {
  80053b:	3d ff 00 00 00       	cmp    $0xff,%eax
  800540:	75 19                	jne    80055b <putch+0x38>
		sys_cputs(b->buf, b->idx);
  800542:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  800549:	00 
  80054a:	8d 43 08             	lea    0x8(%ebx),%eax
  80054d:	89 04 24             	mov    %eax,(%esp)
  800550:	e8 4f fb ff ff       	call   8000a4 <sys_cputs>
		b->idx = 0;
  800555:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
