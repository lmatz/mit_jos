...
forkchild(const char *cur, char branch)
{
  ...
  80004a:	e8 a1 07 00 00       	call   8007f0 <strlen>
  ...
  800061:	c7 44 24 08 20 16 80 	movl   $0x801620,0x8(%esp)
  800068:	00 
  800069:	c7 44 24 04 04 00 00 	movl   $0x4,0x4(%esp)
  800070:	00 
  800071:	8d 45 f4             	lea    -0xc(%ebp),%eax
  800074:	89 04 24             	mov    %eax,(%esp)
  800077:	e8 16 07 00 00       	call   800792 <snprintf>
	if (fork() == 0) {
  80007c:	e8 2d 10 00 00       	call   8010ae <fork>
...
forktree(const char *cur)
{
  ...
  8000a6:	8b 5d 08             	mov    0x8(%ebp),%ebx
	cprintf("%04x: I am '%s'\n", sys_getenvid(), cur);
  8000a9:	e8 e7 0d 00 00       	call   800e95 <sys_getenvid>
  8000ae:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  8000b2:	89 44 24 04          	mov    %eax,0x4(%esp)
  8000b6:	c7 04 24 25 16 80 00 	movl   $0x801625,(%esp)
...
umain(int argc, char **argv)
{
  ...
  8000eb:	83 ec 18             	sub    $0x18,%esp
	forktree("");
  8000ee:	c7 04 24 35 16 80 00 	movl   $0x801635,(%esp)
...
libmain(int argc, char **argv)
{
  ...
  80010e:	e8 82 0d 00 00       	call   800e95 <sys_getenvid>
...
exit(void)
{
  ...
  800159:	e8 6b 0d 00 00       	call   800ec9 <sys_env_destroy>
}
  80015e:	c9                   	leave  
  80015f:	c3                   	ret    
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80019c:	e8 be 01 00 00       	call   80035f <vprintfmt>
  ...
  8001b4:	e8 f7 09 00 00       	call   800bb0 <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  800208:	e8 a3 09 00 00       	call   800bb0 <sys_cputs>
		b->idx = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80028f:	e8 1c 11 00 00       	call   8013b0 <__udivdi3>
  ...
  8002ea:	e8 f1 11 00 00       	call   8014e0 <__umoddi3>
  8002ef:	89 74 24 04          	mov    %esi,0x4(%esp)
  8002f3:	0f be 80 40 16 80 00 	movsbl 0x801640(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003d7:	ff 24 8d 00 17 80 00 	jmp    *0x801700(,%ecx,4)
  ...
  8004ba:	c7 44 24 08 5a 16 80 	movl   $0x80165a,0x8(%esp)
  8004c1:	00 
  ...
  8004f1:	bb 5d 16 80 00       	mov    $0x80165d,%ebx
				p = "(null)";
			if (width > 0 && padc != '-')
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800bf8:	c7 04 24 88 18 80 00 	movl   $0x801888,(%esp)
  800bff:	e8 bd f5 ff ff       	call   8001c1 <cprintf>
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800c29:	00 
  800c2a:	c7 44 24 08 b4 18 80 	movl   $0x8018b4,0x8(%esp)
  800c31:	00 
  800c32:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c39:	00 
  800c3a:	c7 04 24 d1 18 80 00 	movl   $0x8018d1,(%esp)
  800c41:	e8 6e 06 00 00       	call   8012b4 <_panic>
{
	if (upcall==NULL) {
		cprintf("lib sys_env_set_pgfault_up: upcall is NULL\n");
	}
...
sys_ipc_recv(void *dstva)
{
  ...
  800c86:	00 
  800c87:	c7 44 24 08 b4 18 80 	movl   $0x8018b4,0x8(%esp)
  800c8e:	00 
  800c8f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c96:	00 
  800c97:	c7 04 24 d1 18 80 00 	movl   $0x8018d1,(%esp)
  800c9e:	e8 11 06 00 00       	call   8012b4 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d1c:	00 
  800d1d:	c7 44 24 08 b4 18 80 	movl   $0x8018b4,0x8(%esp)
  800d24:	00 
  800d25:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d2c:	00 
  800d2d:	c7 04 24 d1 18 80 00 	movl   $0x8018d1,(%esp)
  800d34:	e8 7b 05 00 00       	call   8012b4 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d7a:	00 
  800d7b:	c7 44 24 08 b4 18 80 	movl   $0x8018b4,0x8(%esp)
  800d82:	00 
  800d83:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d8a:	00 
  800d8b:	c7 04 24 d1 18 80 00 	movl   $0x8018d1,(%esp)
  800d92:	e8 1d 05 00 00       	call   8012b4 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800dd8:	00 
  800dd9:	c7 44 24 08 b4 18 80 	movl   $0x8018b4,0x8(%esp)
  800de0:	00 
  800de1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800de8:	00 
  800de9:	c7 04 24 d1 18 80 00 	movl   $0x8018d1,(%esp)
  800df0:	e8 bf 04 00 00       	call   8012b4 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800e37:	00 
  800e38:	c7 44 24 08 b4 18 80 	movl   $0x8018b4,0x8(%esp)
  800e3f:	00 
  800e40:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e47:	00 
  800e48:	c7 04 24 d1 18 80 00 	movl   $0x8018d1,(%esp)
  800e4f:	e8 60 04 00 00       	call   8012b4 <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  800efc:	00 
  800efd:	c7 44 24 08 b4 18 80 	movl   $0x8018b4,0x8(%esp)
  800f04:	00 
  800f05:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f0c:	00 
  800f0d:	c7 04 24 d1 18 80 00 	movl   $0x8018d1,(%esp)
  800f14:	e8 9b 03 00 00       	call   8012b4 <_panic>
...
sfork(void)
{
  ...
  800f62:	c7 44 24 08 df 18 80 	movl   $0x8018df,0x8(%esp)
  800f69:	00 
  800f6a:	c7 44 24 04 f6 00 00 	movl   $0xf6,0x4(%esp)
  800f71:	00 
  800f72:	c7 04 24 f5 18 80 00 	movl   $0x8018f5,(%esp)
  800f79:	e8 36 03 00 00       	call   8012b4 <_panic>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800f91:	c7 44 24 08 20 19 80 	movl   $0x801920,0x8(%esp)
  800f98:	00 
  800f99:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  800fa0:	00 
  800fa1:	c7 04 24 f5 18 80 00 	movl   $0x8018f5,(%esp)
  800fa8:	e8 07 03 00 00       	call   8012b4 <_panic>
	} 
  ...
  800fbe:	c7 44 24 08 54 19 80 	movl   $0x801954,0x8(%esp)
  800fc5:	00 
  800fc6:	c7 44 24 04 26 00 00 	movl   $0x26,0x4(%esp)
  800fcd:	00 
  800fce:	c7 04 24 f5 18 80 00 	movl   $0x8018f5,(%esp)
  800fd5:	e8 da 02 00 00       	call   8012b4 <_panic>
	// Hint:
  ...
  800ffd:	c7 44 24 08 84 19 80 	movl   $0x801984,0x8(%esp)
  801004:	00 
  801005:	c7 44 24 04 39 00 00 	movl   $0x39,0x4(%esp)
  80100c:	00 
  80100d:	c7 04 24 f5 18 80 00 	movl   $0x8018f5,(%esp)
  801014:	e8 9b 02 00 00       	call   8012b4 <_panic>
	}
  ...
  80105b:	c7 44 24 08 00 19 80 	movl   $0x801900,0x8(%esp)
  801062:	00 
  801063:	c7 44 24 04 40 00 00 	movl   $0x40,0x4(%esp)
  80106a:	00 
  80106b:	c7 04 24 f5 18 80 00 	movl   $0x8018f5,(%esp)
  801072:	e8 3d 02 00 00       	call   8012b4 <_panic>
	}
  ...
  80108b:	c7 44 24 08 ac 19 80 	movl   $0x8019ac,0x8(%esp)
  801092:	00 
  801093:	c7 44 24 04 45 00 00 	movl   $0x45,0x4(%esp)
  80109a:	00 
  80109b:	c7 04 24 f5 18 80 00 	movl   $0x8018f5,(%esp)
  8010a2:	e8 0d 02 00 00       	call   8012b4 <_panic>
	}
	return;
...
fork(void)
{
  ...
  8010c6:	e8 41 02 00 00       	call   80130c <set_pgfault_handler>
...
//	}	
  ...
  801273:	c7 44 24 04 80 13 80 	movl   $0x801380,0x4(%esp)
  80127a:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  8012bf:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  8012c5:	e8 cb fb ff ff       	call   800e95 <sys_getenvid>
  ...
  8012e0:	c7 04 24 cc 19 80 00 	movl   $0x8019cc,(%esp)
  8012e7:	e8 d5 ee ff ff       	call   8001c1 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8012ec:	89 74 24 04          	mov    %esi,0x4(%esp)
  8012f0:	8b 45 10             	mov    0x10(%ebp),%eax
  8012f3:	89 04 24             	mov    %eax,(%esp)
  8012f6:	e8 65 ee ff ff       	call   800160 <vcprintf>
	cprintf("\n");
  8012fb:	c7 04 24 34 16 80 00 	movl   $0x801634,(%esp)
  801302:	e8 ba ee ff ff       	call   8001c1 <cprintf>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801312:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  801319:	75 58                	jne    801373 <set_pgfault_handler+0x67>
		// First time through!
		// LAB 4: Your code here.
  ...
  80131b:	a1 04 20 80 00       	mov    0x802004,%eax
  ...
  801336:	e8 c7 fa ff ff       	call   800e02 <sys_page_alloc>
  80133b:	85 c0                	test   %eax,%eax
  80133d:	74 1c                	je     80135b <set_pgfault_handler+0x4f>
			panic("set_pgfault_handler: sys_page_alloc fail\n");
  80133f:	c7 44 24 08 f0 19 80 	movl   $0x8019f0,0x8(%esp)
  801346:	00 
  801347:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80134e:	00 
  80134f:	c7 04 24 1c 1a 80 00 	movl   $0x801a1c,(%esp)
  801356:	e8 59 ff ff ff       	call   8012b4 <_panic>
		}
		sys_env_set_pgfault_upcall(thisenv->env_id,_pgfault_upcall);
  80135b:	a1 04 20 80 00       	mov    0x802004,%eax
  801360:	8b 40 48             	mov    0x48(%eax),%eax
  801363:	c7 44 24 04 80 13 80 	movl   $0x801380,0x4(%esp)
  80136a:	00 
  80136b:	89 04 24             	mov    %eax,(%esp)
  80136e:	e8 70 f8 ff ff       	call   800be3 <sys_env_set_pgfault_upcall>
	}
  ...
  801376:	a3 08 20 80 00       	mov    %eax,0x802008
...
_pgfault_upcall:
  ...
  801381:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  801388:	83 c4 04             	add    $0x4,%esp
	...
	// LAB 4: Your code here.
	movl  %esp , %ebx
  80138b:	89 e3                	mov    %esp,%ebx
	movl  40(%esp) , %eax
  80138d:	8b 44 24 28          	mov    0x28(%esp),%eax
	movl  48(%esp) , %esp
  801391:	8b 64 24 30          	mov    0x30(%esp),%esp
	pushl  %eax 
  801395:	50                   	push   %eax
	...
	// LAB 4: Your code here.
	movl  %ebx , %esp
  801396:	89 dc                	mov    %ebx,%esp
	subl  $4 , 48(%esp)
  801398:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	popl  %eax
  80139d:	58                   	pop    %eax
	popl  %eax
  80139e:	58                   	pop    %eax
...
008013b0 <__udivdi3>:
  ...
  8013c1:	8b 7d 0c             	mov    0xc(%ebp),%edi
  8013c4:	85 c0                	test   %eax,%eax
  8013c6:	89 55 f0             	mov    %edx,-0x10(%ebp)
  8013c9:	75 35                	jne    801400 <__udivdi3+0x50>
  8013cb:	39 fe                	cmp    %edi,%esi
  8013cd:	77 61                	ja     801430 <__udivdi3+0x80>
  8013cf:	85 f6                	test   %esi,%esi
  8013d1:	75 0b                	jne    8013de <__udivdi3+0x2e>
  8013d3:	b8 01 00 00 00       	mov    $0x1,%eax
  8013d8:	31 d2                	xor    %edx,%edx
  8013da:	f7 f6                	div    %esi
  8013dc:	89 c6                	mov    %eax,%esi
  8013de:	8b 4d f0             	mov    -0x10(%ebp),%ecx
  8013e1:	31 d2                	xor    %edx,%edx
  8013e3:	89 f8                	mov    %edi,%eax
  8013e5:	f7 f6                	div    %esi
  8013e7:	89 c7                	mov    %eax,%edi
  8013e9:	89 c8                	mov    %ecx,%eax
  8013eb:	f7 f6                	div    %esi
  ...
  801402:	77 1c                	ja     801420 <__udivdi3+0x70>
  801404:	0f bd d0             	bsr    %eax,%edx
  801407:	83 f2 1f             	xor    $0x1f,%edx
  80140a:	89 55 f4             	mov    %edx,-0xc(%ebp)
  80140d:	75 39                	jne    801448 <__udivdi3+0x98>
  80140f:	3b 75 f0             	cmp    -0x10(%ebp),%esi
  801412:	0f 86 a0 00 00 00    	jbe    8014b8 <__udivdi3+0x108>
  801418:	39 f8                	cmp    %edi,%eax
  80141a:	0f 82 98 00 00 00    	jb     8014b8 <__udivdi3+0x108>
  801420:	31 ff                	xor    %edi,%edi
  801422:	31 c9                	xor    %ecx,%ecx
  ...
  80142e:	c3                   	ret    
  80142f:	90                   	nop
  801430:	89 d1                	mov    %edx,%ecx
  801432:	89 fa                	mov    %edi,%edx
  801434:	89 c8                	mov    %ecx,%eax
  801436:	31 ff                	xor    %edi,%edi
  801438:	f7 f6                	div    %esi
  80143a:	89 c1                	mov    %eax,%ecx
  ...
  801446:	c3                   	ret    
  801447:	90                   	nop
  801448:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  80144c:	89 f2                	mov    %esi,%edx
  80144e:	d3 e0                	shl    %cl,%eax
  801450:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801453:	b8 20 00 00 00       	mov    $0x20,%eax
  801458:	2b 45 f4             	sub    -0xc(%ebp),%eax
  80145b:	89 c1                	mov    %eax,%ecx
  80145d:	d3 ea                	shr    %cl,%edx
  80145f:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  801463:	0b 55 ec             	or     -0x14(%ebp),%edx
  801466:	d3 e6                	shl    %cl,%esi
  801468:	89 c1                	mov    %eax,%ecx
  80146a:	89 75 e8             	mov    %esi,-0x18(%ebp)
  80146d:	89 fe                	mov    %edi,%esi
  80146f:	d3 ee                	shr    %cl,%esi
  801471:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  801475:	89 55 ec             	mov    %edx,-0x14(%ebp)
  801478:	8b 55 f0             	mov    -0x10(%ebp),%edx
  80147b:	d3 e7                	shl    %cl,%edi
  80147d:	89 c1                	mov    %eax,%ecx
  80147f:	d3 ea                	shr    %cl,%edx
  801481:	09 d7                	or     %edx,%edi
  ...
  80148e:	f7 65 e8             	mull   -0x18(%ebp)
  801491:	39 d6                	cmp    %edx,%esi
  801493:	89 55 ec             	mov    %edx,-0x14(%ebp)
  801496:	72 30                	jb     8014c8 <__udivdi3+0x118>
  801498:	8b 55 f0             	mov    -0x10(%ebp),%edx
  80149b:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  80149f:	d3 e2                	shl    %cl,%edx
  8014a1:	39 c2                	cmp    %eax,%edx
  8014a3:	73 05                	jae    8014aa <__udivdi3+0xfa>
  8014a5:	3b 75 ec             	cmp    -0x14(%ebp),%esi
  8014a8:	74 1e                	je     8014c8 <__udivdi3+0x118>
  8014aa:	89 f9                	mov    %edi,%ecx
  8014ac:	31 ff                	xor    %edi,%edi
  8014ae:	e9 71 ff ff ff       	jmp    801424 <__udivdi3+0x74>
  8014b3:	90                   	nop
  8014b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  8014b8:	31 ff                	xor    %edi,%edi
  8014ba:	b9 01 00 00 00       	mov    $0x1,%ecx
  8014bf:	e9 60 ff ff ff       	jmp    801424 <__udivdi3+0x74>
  8014c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  8014c8:	8d 4f ff             	lea    -0x1(%edi),%ecx
  8014cb:	31 ff                	xor    %edi,%edi
...
008014e0 <__umoddi3>:
  ...
  8014e3:	57                   	push   %edi
  8014e4:	56                   	push   %esi
  8014e5:	83 ec 20             	sub    $0x20,%esp
  8014e8:	8b 55 14             	mov    0x14(%ebp),%edx
  8014eb:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8014ee:	8b 7d 10             	mov    0x10(%ebp),%edi
  8014f1:	8b 75 0c             	mov    0xc(%ebp),%esi
  8014f4:	85 d2                	test   %edx,%edx
  8014f6:	89 c8                	mov    %ecx,%eax
  8014f8:	89 4d f4             	mov    %ecx,-0xc(%ebp)
  8014fb:	75 13                	jne    801510 <__umoddi3+0x30>
  8014fd:	39 f7                	cmp    %esi,%edi
  8014ff:	76 3f                	jbe    801540 <__umoddi3+0x60>
  801501:	89 f2                	mov    %esi,%edx
  801503:	f7 f7                	div    %edi
  801505:	89 d0                	mov    %edx,%eax
  801507:	31 d2                	xor    %edx,%edx
  801509:	83 c4 20             	add    $0x20,%esp
  80150c:	5e                   	pop    %esi
  80150d:	5f                   	pop    %edi
  80150e:	5d                   	pop    %ebp
  80150f:	c3                   	ret    
  801510:	39 f2                	cmp    %esi,%edx
  801512:	77 4c                	ja     801560 <__umoddi3+0x80>
  801514:	0f bd ca             	bsr    %edx,%ecx
  801517:	83 f1 1f             	xor    $0x1f,%ecx
  80151a:	89 4d f0             	mov    %ecx,-0x10(%ebp)
  80151d:	75 51                	jne    801570 <__umoddi3+0x90>
  80151f:	3b 7d f4             	cmp    -0xc(%ebp),%edi
  801522:	0f 87 e0 00 00 00    	ja     801608 <__umoddi3+0x128>
  801528:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80152b:	29 f8                	sub    %edi,%eax
  80152d:	19 d6                	sbb    %edx,%esi
  ...
  801540:	85 ff                	test   %edi,%edi
  801542:	75 0b                	jne    80154f <__umoddi3+0x6f>
  801544:	b8 01 00 00 00       	mov    $0x1,%eax
  801549:	31 d2                	xor    %edx,%edx
  80154b:	f7 f7                	div    %edi
  ...
  801558:	f7 f7                	div    %edi
  80155a:	eb a9                	jmp    801505 <__umoddi3+0x25>
  ...
  801570:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  801574:	d3 e2                	shl    %cl,%edx
  801576:	89 55 f4             	mov    %edx,-0xc(%ebp)
  801579:	ba 20 00 00 00       	mov    $0x20,%edx
  80157e:	2b 55 f0             	sub    -0x10(%ebp),%edx
  801581:	89 55 ec             	mov    %edx,-0x14(%ebp)
  801584:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  801588:	89 fa                	mov    %edi,%edx
  80158a:	d3 ea                	shr    %cl,%edx
  80158c:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  801590:	0b 55 f4             	or     -0xc(%ebp),%edx
  801593:	d3 e7                	shl    %cl,%edi
  801595:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  801599:	89 55 f4             	mov    %edx,-0xc(%ebp)
  80159c:	89 f2                	mov    %esi,%edx
  80159e:	89 7d e8             	mov    %edi,-0x18(%ebp)
  ...
  8015b0:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  8015b4:	d3 ea                	shr    %cl,%edx
  8015b6:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  8015ba:	09 d6                	or     %edx,%esi
  8015bc:	89 f0                	mov    %esi,%eax
  8015be:	8b 75 e4             	mov    -0x1c(%ebp),%esi
  8015c1:	d3 e7                	shl    %cl,%edi
  8015c3:	89 f2                	mov    %esi,%edx
  8015c5:	f7 75 f4             	divl   -0xc(%ebp)
  8015c8:	89 d6                	mov    %edx,%esi
  8015ca:	f7 65 e8             	mull   -0x18(%ebp)
  8015cd:	39 d6                	cmp    %edx,%esi
  8015cf:	72 2b                	jb     8015fc <__umoddi3+0x11c>
  8015d1:	39 c7                	cmp    %eax,%edi
  8015d3:	72 23                	jb     8015f8 <__umoddi3+0x118>
  8015d5:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  8015d9:	29 c7                	sub    %eax,%edi
  8015db:	19 d6                	sbb    %edx,%esi
  8015dd:	89 f0                	mov    %esi,%eax
  8015df:	89 f2                	mov    %esi,%edx
  8015e1:	d3 ef                	shr    %cl,%edi
  8015e3:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  8015e7:	d3 e0                	shl    %cl,%eax
  8015e9:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  8015ed:	09 f8                	or     %edi,%eax
  8015ef:	d3 ea                	shr    %cl,%edx
  8015f1:	83 c4 20             	add    $0x20,%esp
  8015f4:	5e                   	pop    %esi
  8015f5:	5f                   	pop    %edi
  8015f6:	5d                   	pop    %ebp
  8015f7:	c3                   	ret    
  8015f8:	39 d6                	cmp    %edx,%esi
  8015fa:	75 d9                	jne    8015d5 <__umoddi3+0xf5>
  8015fc:	2b 45 e8             	sub    -0x18(%ebp),%eax
  8015ff:	1b 55 f4             	sbb    -0xc(%ebp),%edx
  801602:	eb d1                	jmp    8015d5 <__umoddi3+0xf5>
  801604:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  801608:	39 f2                	cmp    %esi,%edx
  80160a:	0f 82 18 ff ff ff    	jb     801528 <__umoddi3+0x48>
  801610:	e9 1d ff ff ff       	jmp    801532 <__umoddi3+0x52>
