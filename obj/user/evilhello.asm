...
libmain(int argc, char **argv)
{
  ...
  800062:	e8 32 03 00 00       	call   800399 <sys_getenvid>
...
exit(void)
{
  ...
  8000ad:	e8 1b 03 00 00       	call   8003cd <sys_env_destroy>
}
  8000b2:	c9                   	leave  
  8000b3:	c3                   	ret    
...
008000e7 <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8000f3:	89 7d fc             	mov    %edi,-0x4(%ebp)
	if (upcall==NULL) {
  8000f6:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
  8000fa:	75 0c                	jne    800108 <sys_env_set_pgfault_upcall+0x21>
		cprintf("lib sys_env_set_pgfault_up: upcall is NULL\n");
  8000fc:	c7 04 24 8c 11 80 00 	movl   $0x80118c,(%esp)
  800103:	e8 11 04 00 00       	call   800519 <cprintf>
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  80010d:	b8 09 00 00 00       	mov    $0x9,%eax
  800112:	8b 55 08             	mov    0x8(%ebp),%edx
  800115:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  800118:	89 df                	mov    %ebx,%edi
  ...
  800120:	7e 28                	jle    80014a <sys_env_set_pgfault_upcall+0x63>
		panic("syscall %d returned %d (> 0)", num, ret);
  800122:	89 44 24 10          	mov    %eax,0x10(%esp)
  800126:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  80012d:	00 
  80012e:	c7 44 24 08 b8 11 80 	movl   $0x8011b8,0x8(%esp)
  800135:	00 
  800136:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80013d:	00 
  80013e:	c7 04 24 d5 11 80 00 	movl   $0x8011d5,(%esp)
  800145:	e8 16 03 00 00       	call   800460 <_panic>
{
	if (upcall==NULL) {
		cprintf("lib sys_env_set_pgfault_up: upcall is NULL\n");
	}
  ...
  80014a:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  80014d:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800150:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800153:	89 ec                	mov    %ebp,%esp
  800155:	5d                   	pop    %ebp
  800156:	c3                   	ret    

00800157 <sys_ipc_recv>:
...
sys_ipc_recv(void *dstva)
{
  ...
  80015a:	83 ec 38             	sub    $0x38,%esp
  80015d:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800160:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800163:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  80016b:	b8 0c 00 00 00       	mov    $0xc,%eax
  800170:	8b 55 08             	mov    0x8(%ebp),%edx
  800173:	89 cb                	mov    %ecx,%ebx
  800175:	89 cf                	mov    %ecx,%edi
  800177:	89 ce                	mov    %ecx,%esi
  ...
  80017d:	7e 28                	jle    8001a7 <sys_ipc_recv+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  80017f:	89 44 24 10          	mov    %eax,0x10(%esp)
  800183:	c7 44 24 0c 0c 00 00 	movl   $0xc,0xc(%esp)
  80018a:	00 
  80018b:	c7 44 24 08 b8 11 80 	movl   $0x8011b8,0x8(%esp)
  800192:	00 
  800193:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80019a:	00 
  80019b:	c7 04 24 d5 11 80 00 	movl   $0x8011d5,(%esp)
  8001a2:	e8 b9 02 00 00       	call   800460 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8001bd:	89 74 24 04          	mov    %esi,0x4(%esp)
  ...
  8001ca:	b8 0b 00 00 00       	mov    $0xb,%eax
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800200:	b8 08 00 00 00       	mov    $0x8,%eax
  ...
  800213:	7e 28                	jle    80023d <sys_env_set_status+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  800215:	89 44 24 10          	mov    %eax,0x10(%esp)
  800219:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  800220:	00 
  800221:	c7 44 24 08 b8 11 80 	movl   $0x8011b8,0x8(%esp)
  800228:	00 
  800229:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800230:	00 
  800231:	c7 04 24 d5 11 80 00 	movl   $0x8011d5,(%esp)
  800238:	e8 23 02 00 00       	call   800460 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80023d:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800240:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800243:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800246:	89 ec                	mov    %ebp,%esp
  800248:	5d                   	pop    %ebp
  800249:	c3                   	ret    
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80024d:	83 ec 38             	sub    $0x38,%esp
  800250:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800253:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800256:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800271:	7e 28                	jle    80029b <sys_page_unmap+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  800273:	89 44 24 10          	mov    %eax,0x10(%esp)
  800277:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  80027e:	00 
  80027f:	c7 44 24 08 b8 11 80 	movl   $0x8011b8,0x8(%esp)
  800286:	00 
  800287:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80028e:	00 
  80028f:	c7 04 24 d5 11 80 00 	movl   $0x8011d5,(%esp)
  800296:	e8 c5 01 00 00       	call   800460 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80029b:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  80029e:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8002a1:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8002a4:	89 ec                	mov    %ebp,%esp
  8002a6:	5d                   	pop    %ebp
  8002a7:	c3                   	ret    

008002a8 <sys_page_map>:
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8002ab:	83 ec 38             	sub    $0x38,%esp
  8002ae:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8002b1:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8002b4:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
	...
	asm volatile("int %1\n"
  8002b7:	b8 05 00 00 00       	mov    $0x5,%eax
  8002bc:	8b 75 18             	mov    0x18(%ebp),%esi
  ...
  8002cf:	7e 28                	jle    8002f9 <sys_page_map+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002d1:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002d5:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  8002dc:	00 
  8002dd:	c7 44 24 08 b8 11 80 	movl   $0x8011b8,0x8(%esp)
  8002e4:	00 
  8002e5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002ec:	00 
  8002ed:	c7 04 24 d5 11 80 00 	movl   $0x8011d5,(%esp)
  8002f4:	e8 67 01 00 00       	call   800460 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8002f9:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8002fc:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8002ff:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800302:	89 ec                	mov    %ebp,%esp
  800304:	5d                   	pop    %ebp
  800305:	c3                   	ret    

00800306 <sys_page_alloc>:
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800309:	83 ec 38             	sub    $0x38,%esp
  80030c:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  80030f:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800312:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  80032e:	7e 28                	jle    800358 <sys_page_alloc+0x52>
		panic("syscall %d returned %d (> 0)", num, ret);
  800330:	89 44 24 10          	mov    %eax,0x10(%esp)
  800334:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  80033b:	00 
  80033c:	c7 44 24 08 b8 11 80 	movl   $0x8011b8,0x8(%esp)
  800343:	00 
  800344:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80034b:	00 
  80034c:	c7 04 24 d5 11 80 00 	movl   $0x8011d5,(%esp)
  800353:	e8 08 01 00 00       	call   800460 <_panic>
...
sys_yield(void)
{
  ...
  80036e:	89 74 24 04          	mov    %esi,0x4(%esp)
  800372:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  80037b:	b8 0a 00 00 00       	mov    $0xa,%eax
  800380:	89 d1                	mov    %edx,%ecx
  800382:	89 d3                	mov    %edx,%ebx
  800384:	89 d7                	mov    %edx,%edi
...
sys_yield(void)
{
  ...
  80038a:	8b 1c 24             	mov    (%esp),%ebx
  80038d:	8b 74 24 04          	mov    0x4(%esp),%esi
  800391:	8b 7c 24 08          	mov    0x8(%esp),%edi
  800395:	89 ec                	mov    %ebp,%esp
  800397:	5d                   	pop    %ebp
  800398:	c3                   	ret    

00800399 <sys_getenvid>:
...
sys_getenvid(void)
{
  ...
  8003af:	b8 02 00 00 00       	mov    $0x2,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  8003d0:	83 ec 38             	sub    $0x38,%esp
  8003d3:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8003d6:	89 75 f8             	mov    %esi,-0x8(%ebp)
  ...
  8003e1:	b8 03 00 00 00       	mov    $0x3,%eax
  ...
  8003f3:	7e 28                	jle    80041d <sys_env_destroy+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003f5:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003f9:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  800400:	00 
  800401:	c7 44 24 08 b8 11 80 	movl   $0x8011b8,0x8(%esp)
  800408:	00 
  800409:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800410:	00 
  800411:	c7 04 24 d5 11 80 00 	movl   $0x8011d5,(%esp)
  800418:	e8 43 00 00 00       	call   800460 <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  80041d:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800420:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800423:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800426:	89 ec                	mov    %ebp,%esp
  800428:	5d                   	pop    %ebp
  800429:	c3                   	ret    
...
sys_cgetc(void)
{
  ...
  800430:	89 1c 24             	mov    %ebx,(%esp)
  800433:	89 74 24 04          	mov    %esi,0x4(%esp)
  800437:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800447:	89 d3                	mov    %edx,%ebx
  800449:	89 d7                	mov    %edx,%edi
  80044b:	89 d6                	mov    %edx,%esi
...
sys_cgetc(void)
{
  ...
  80044f:	8b 1c 24             	mov    (%esp),%ebx
  800452:	8b 74 24 04          	mov    0x4(%esp),%esi
  800456:	8b 7c 24 08          	mov    0x8(%esp),%edi
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  800471:	e8 23 ff ff ff       	call   800399 <sys_getenvid>
  ...
  80048c:	c7 04 24 e4 11 80 00 	movl   $0x8011e4,(%esp)
  800493:	e8 81 00 00 00       	call   800519 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800498:	89 74 24 04          	mov    %esi,0x4(%esp)
  80049c:	8b 45 10             	mov    0x10(%ebp),%eax
  80049f:	89 04 24             	mov    %eax,(%esp)
  8004a2:	e8 11 00 00 00       	call   8004b8 <vcprintf>
	cprintf("\n");
  8004a7:	c7 04 24 08 12 80 00 	movl   $0x801208,(%esp)
  8004ae:	e8 66 00 00 00       	call   800519 <cprintf>
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8004bb:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct printbuf b;
  ...
  8004ed:	c7 04 24 33 05 80 00 	movl   $0x800533,(%esp)
  8004f4:	e8 c6 01 00 00       	call   8006bf <vprintfmt>
	sys_cputs(b.buf, b.idx);
  8004f9:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  8004ff:	89 44 24 04          	mov    %eax,0x4(%esp)
  800503:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  800509:	89 04 24             	mov    %eax,(%esp)
  80050c:	e8 a3 fb ff ff       	call   8000b4 <sys_cputs>

	return b.cnt;
}
  800511:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
  800517:	c9                   	leave  
  800518:	c3                   	ret    
  ...
  80051f:	8d 45 0c             	lea    0xc(%ebp),%eax
{
  ...
  80052c:	e8 87 ff ff ff       	call   8004b8 <vcprintf>
	va_end(ap);
...
putch(int ch, struct printbuf *b)
{
  ...
  800536:	53                   	push   %ebx
  800537:	83 ec 14             	sub    $0x14,%esp
  80053a:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	b->buf[b->idx++] = ch;
  80053d:	8b 03                	mov    (%ebx),%eax
  80053f:	8b 55 08             	mov    0x8(%ebp),%edx
  800542:	88 54 03 08          	mov    %dl,0x8(%ebx,%eax,1)
  800546:	83 c0 01             	add    $0x1,%eax
  800549:	89 03                	mov    %eax,(%ebx)
	if (b->idx == 256-1) {
  80054b:	3d ff 00 00 00       	cmp    $0xff,%eax
  800550:	75 19                	jne    80056b <putch+0x38>
		sys_cputs(b->buf, b->idx);
  800552:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  800559:	00 
  80055a:	8d 43 08             	lea    0x8(%ebx),%eax
  80055d:	89 04 24             	mov    %eax,(%esp)
  800560:	e8 4f fb ff ff       	call   8000b4 <sys_cputs>
		b->idx = 0;
  800565:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
  80056b:	83 43 04 01          	addl   $0x1,0x4(%ebx)
}
  80056f:	83 c4 14             	add    $0x14,%esp
  800572:	5b                   	pop    %ebx
  800573:	5d                   	pop    %ebp
  800574:	c3                   	ret    
	...
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800653:	0f be 80 0a 12 80 00 	movsbl 0x80120a(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8007fa:	c7 44 24 08 1b 12 80 	movl   $0x80121b,0x8(%esp)
  800801:	00 
  ...
  80081a:	c7 44 24 08 24 12 80 	movl   $0x801224,0x8(%esp)
  800821:	00 
  ...
  800851:	bb 27 12 80 00       	mov    $0x801227,%ebx
				p = "(null)";
			if (width > 0 && padc != '-')
