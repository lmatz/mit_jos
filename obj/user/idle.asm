...
umain(int argc, char **argv)
{
  ...
  800037:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  80003a:	c7 05 00 20 80 00 80 	movl   $0x801180,0x802000
  800041:	11 80 00 
	...
	while (1) {
		sys_yield();
  800044:	e8 18 03 00 00       	call   800361 <sys_yield>
...
libmain(int argc, char **argv)
{
  ...
  80005e:	e8 32 03 00 00       	call   800395 <sys_getenvid>
...
exit(void)
{
  ...
  8000a9:	e8 1b 03 00 00       	call   8003c9 <sys_env_destroy>
}
  8000ae:	c9                   	leave  
  8000af:	c3                   	ret    
...
sys_cputs(const char *s, size_t len)
{
  ...
  8000d7:	8b 74 24 04          	mov    0x4(%esp),%esi
  8000db:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8000df:	89 ec                	mov    %ebp,%esp
  8000e1:	5d                   	pop    %ebp
  8000e2:	c3                   	ret    

008000e3 <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8000e6:	83 ec 38             	sub    $0x38,%esp
  8000e9:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8000ec:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8000ef:	89 7d fc             	mov    %edi,-0x4(%ebp)
	if (upcall==NULL) {
  8000f2:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
  8000f6:	75 0c                	jne    800104 <sys_env_set_pgfault_upcall+0x21>
		cprintf("lib sys_env_set_pgfault_up: upcall is NULL\n");
  8000f8:	c7 04 24 90 11 80 00 	movl   $0x801190,(%esp)
  8000ff:	e8 11 04 00 00       	call   800515 <cprintf>
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
	...
	asm volatile("int %1\n"
  800104:	bb 00 00 00 00       	mov    $0x0,%ebx
  800109:	b8 09 00 00 00       	mov    $0x9,%eax
  80010e:	8b 55 08             	mov    0x8(%ebp),%edx
  800111:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  800114:	89 df                	mov    %ebx,%edi
  800116:	89 de                	mov    %ebx,%esi
  ...
  80011c:	7e 28                	jle    800146 <sys_env_set_pgfault_upcall+0x63>
		panic("syscall %d returned %d (> 0)", num, ret);
  80011e:	89 44 24 10          	mov    %eax,0x10(%esp)
  800122:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  800129:	00 
  80012a:	c7 44 24 08 bc 11 80 	movl   $0x8011bc,0x8(%esp)
  800131:	00 
  800132:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800139:	00 
  80013a:	c7 04 24 d9 11 80 00 	movl   $0x8011d9,(%esp)
  800141:	e8 16 03 00 00       	call   80045c <_panic>
{
	if (upcall==NULL) {
		cprintf("lib sys_env_set_pgfault_up: upcall is NULL\n");
	}
  ...
  800146:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800149:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80014c:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80014f:	89 ec                	mov    %ebp,%esp
  800151:	5d                   	pop    %ebp
  800152:	c3                   	ret    

00800153 <sys_ipc_recv>:
...
sys_ipc_recv(void *dstva)
{
  ...
  800167:	b8 0c 00 00 00       	mov    $0xc,%eax
  80016c:	8b 55 08             	mov    0x8(%ebp),%edx
  80016f:	89 cb                	mov    %ecx,%ebx
  800171:	89 cf                	mov    %ecx,%edi
  800173:	89 ce                	mov    %ecx,%esi
  ...
  800179:	7e 28                	jle    8001a3 <sys_ipc_recv+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  80017b:	89 44 24 10          	mov    %eax,0x10(%esp)
  80017f:	c7 44 24 0c 0c 00 00 	movl   $0xc,0xc(%esp)
  800186:	00 
  800187:	c7 44 24 08 bc 11 80 	movl   $0x8011bc,0x8(%esp)
  80018e:	00 
  80018f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800196:	00 
  800197:	c7 04 24 d9 11 80 00 	movl   $0x8011d9,(%esp)
  80019e:	e8 b9 02 00 00       	call   80045c <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8001dc:	8b 74 24 04          	mov    0x4(%esp),%esi
  8001e0:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8001e4:	89 ec                	mov    %ebp,%esp
  8001e6:	5d                   	pop    %ebp
  8001e7:	c3                   	ret    

008001e8 <sys_env_set_status>:
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8001fc:	b8 08 00 00 00       	mov    $0x8,%eax
  ...
  80020f:	7e 28                	jle    800239 <sys_env_set_status+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  800211:	89 44 24 10          	mov    %eax,0x10(%esp)
  800215:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  80021c:	00 
  80021d:	c7 44 24 08 bc 11 80 	movl   $0x8011bc,0x8(%esp)
  800224:	00 
  800225:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80022c:	00 
  80022d:	c7 04 24 d9 11 80 00 	movl   $0x8011d9,(%esp)
  800234:	e8 23 02 00 00       	call   80045c <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800239:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  80023c:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80023f:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800242:	89 ec                	mov    %ebp,%esp
  800244:	5d                   	pop    %ebp
  800245:	c3                   	ret    

00800246 <sys_page_unmap>:
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800249:	83 ec 38             	sub    $0x38,%esp
  80024c:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  80024f:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800252:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  80026d:	7e 28                	jle    800297 <sys_page_unmap+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  80026f:	89 44 24 10          	mov    %eax,0x10(%esp)
  800273:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  80027a:	00 
  80027b:	c7 44 24 08 bc 11 80 	movl   $0x8011bc,0x8(%esp)
  800282:	00 
  800283:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80028a:	00 
  80028b:	c7 04 24 d9 11 80 00 	movl   $0x8011d9,(%esp)
  800292:	e8 c5 01 00 00       	call   80045c <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800297:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  80029a:	8b 75 f8             	mov    -0x8(%ebp),%esi
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8002b0:	89 7d fc             	mov    %edi,-0x4(%ebp)
	...
	asm volatile("int %1\n"
  8002b3:	b8 05 00 00 00       	mov    $0x5,%eax
  8002b8:	8b 75 18             	mov    0x18(%ebp),%esi
  8002bb:	8b 7d 14             	mov    0x14(%ebp),%edi
  8002be:	8b 5d 10             	mov    0x10(%ebp),%ebx
  ...
  8002cb:	7e 28                	jle    8002f5 <sys_page_map+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002cd:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002d1:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  8002d8:	00 
  8002d9:	c7 44 24 08 bc 11 80 	movl   $0x8011bc,0x8(%esp)
  8002e0:	00 
  8002e1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002e8:	00 
  8002e9:	c7 04 24 d9 11 80 00 	movl   $0x8011d9,(%esp)
  8002f0:	e8 67 01 00 00       	call   80045c <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80032a:	7e 28                	jle    800354 <sys_page_alloc+0x52>
		panic("syscall %d returned %d (> 0)", num, ret);
  80032c:	89 44 24 10          	mov    %eax,0x10(%esp)
  800330:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  800337:	00 
  800338:	c7 44 24 08 bc 11 80 	movl   $0x8011bc,0x8(%esp)
  80033f:	00 
  800340:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800347:	00 
  800348:	c7 04 24 d9 11 80 00 	movl   $0x8011d9,(%esp)
  80034f:	e8 08 01 00 00       	call   80045c <_panic>
...
sys_yield(void)
{
  ...
  800377:	b8 0a 00 00 00       	mov    $0xa,%eax
  80037c:	89 d1                	mov    %edx,%ecx
  80037e:	89 d3                	mov    %edx,%ebx
  800380:	89 d7                	mov    %edx,%edi
...
sys_yield(void)
{
  ...
  800386:	8b 1c 24             	mov    (%esp),%ebx
  800389:	8b 74 24 04          	mov    0x4(%esp),%esi
  80038d:	8b 7c 24 08          	mov    0x8(%esp),%edi
  800391:	89 ec                	mov    %ebp,%esp
  800393:	5d                   	pop    %ebp
  800394:	c3                   	ret    

00800395 <sys_getenvid>:
...
sys_getenvid(void)
{
  ...
  80039b:	89 1c 24             	mov    %ebx,(%esp)
  80039e:	89 74 24 04          	mov    %esi,0x4(%esp)
  8003a2:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8003ab:	b8 02 00 00 00       	mov    $0x2,%eax
  8003b0:	89 d1                	mov    %edx,%ecx
  8003b2:	89 d3                	mov    %edx,%ebx
...
sys_getenvid(void)
{
  ...
  8003ba:	8b 1c 24             	mov    (%esp),%ebx
  8003bd:	8b 74 24 04          	mov    0x4(%esp),%esi
  8003c1:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8003c5:	89 ec                	mov    %ebp,%esp
  8003c7:	5d                   	pop    %ebp
  8003c8:	c3                   	ret    

008003c9 <sys_env_destroy>:
...
sys_env_destroy(envid_t envid)
{
  ...
  8003cc:	83 ec 38             	sub    $0x38,%esp
  8003cf:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8003d2:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8003d5:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8003dd:	b8 03 00 00 00       	mov    $0x3,%eax
  ...
  8003ef:	7e 28                	jle    800419 <sys_env_destroy+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003f1:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003f5:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  8003fc:	00 
  8003fd:	c7 44 24 08 bc 11 80 	movl   $0x8011bc,0x8(%esp)
  800404:	00 
  800405:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80040c:	00 
  80040d:	c7 04 24 d9 11 80 00 	movl   $0x8011d9,(%esp)
  800414:	e8 43 00 00 00       	call   80045c <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  800419:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  80041c:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80041f:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
sys_cgetc(void)
{
  ...
  80042c:	89 1c 24             	mov    %ebx,(%esp)
  80042f:	89 74 24 04          	mov    %esi,0x4(%esp)
  800433:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  80043c:	b8 01 00 00 00       	mov    $0x1,%eax
  800441:	89 d1                	mov    %edx,%ecx
  800443:	89 d3                	mov    %edx,%ebx
...
sys_cgetc(void)
{
  ...
  80044b:	8b 1c 24             	mov    (%esp),%ebx
  80044e:	8b 74 24 04          	mov    0x4(%esp),%esi
  800452:	8b 7c 24 08          	mov    0x8(%esp),%edi
  800456:	89 ec                	mov    %ebp,%esp
  800458:	5d                   	pop    %ebp
  800459:	c3                   	ret    
	...
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  80046d:	e8 23 ff ff ff       	call   800395 <sys_getenvid>
  ...
  800488:	c7 04 24 e8 11 80 00 	movl   $0x8011e8,(%esp)
  80048f:	e8 81 00 00 00       	call   800515 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800494:	89 74 24 04          	mov    %esi,0x4(%esp)
  800498:	8b 45 10             	mov    0x10(%ebp),%eax
  80049b:	89 04 24             	mov    %eax,(%esp)
  80049e:	e8 11 00 00 00       	call   8004b4 <vcprintf>
	cprintf("\n");
  8004a3:	c7 04 24 0c 12 80 00 	movl   $0x80120c,(%esp)
  8004aa:	e8 66 00 00 00       	call   800515 <cprintf>
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8004b7:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct printbuf b;
  ...
  8004db:	89 44 24 08          	mov    %eax,0x8(%esp)
  8004df:	8d 85 f0 fe ff ff    	lea    -0x110(%ebp),%eax
  8004e5:	89 44 24 04          	mov    %eax,0x4(%esp)
  8004e9:	c7 04 24 2f 05 80 00 	movl   $0x80052f,(%esp)
  8004f0:	e8 ca 01 00 00       	call   8006bf <vprintfmt>
	sys_cputs(b.buf, b.idx);
  8004f5:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  8004fb:	89 44 24 04          	mov    %eax,0x4(%esp)
  8004ff:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  800505:	89 04 24             	mov    %eax,(%esp)
  800508:	e8 a3 fb ff ff       	call   8000b0 <sys_cputs>
...
int
cprintf(const char *fmt, ...)
  80051b:	8d 45 0c             	lea    0xc(%ebp),%eax
{
	va_list ap;
	int cnt;
  ...
  800528:	e8 87 ff ff ff       	call   8004b4 <vcprintf>
	va_end(ap);
...
putch(int ch, struct printbuf *b)
{
  ...
  800532:	53                   	push   %ebx
  800533:	83 ec 14             	sub    $0x14,%esp
  800536:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	b->buf[b->idx++] = ch;
  800539:	8b 03                	mov    (%ebx),%eax
  80053b:	8b 55 08             	mov    0x8(%ebp),%edx
  80053e:	88 54 03 08          	mov    %dl,0x8(%ebx,%eax,1)
  800542:	83 c0 01             	add    $0x1,%eax
  800545:	89 03                	mov    %eax,(%ebx)
	if (b->idx == 256-1) {
  800547:	3d ff 00 00 00       	cmp    $0xff,%eax
  80054c:	75 19                	jne    800567 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  80054e:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  800555:	00 
  800556:	8d 43 08             	lea    0x8(%ebx),%eax
  800559:	89 04 24             	mov    %eax,(%esp)
  80055c:	e8 4f fb ff ff       	call   8000b0 <sys_cputs>
		b->idx = 0;
  800561:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
  800567:	83 43 04 01          	addl   $0x1,0x4(%ebx)
}
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800653:	0f be 80 0e 12 80 00 	movsbl 0x80120e(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8007fa:	c7 44 24 08 1f 12 80 	movl   $0x80121f,0x8(%esp)
  800801:	00 
  ...
  80081a:	c7 44 24 08 28 12 80 	movl   $0x801228,0x8(%esp)
  800821:	00 
  ...
  800851:	bb 2b 12 80 00       	mov    $0x80122b,%ebx
				p = "(null)";
			if (width > 0 && padc != '-')
