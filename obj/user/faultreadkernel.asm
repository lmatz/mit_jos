	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800253:	0f be 80 d1 11 80 00 	movsbl 0x8011d1(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800337:	ff 24 8d a0 12 80 00 	jmp    *0x8012a0(,%ecx,4)
  ...
  80041a:	c7 44 24 08 eb 11 80 	movl   $0x8011eb,0x8(%esp)
  800421:	00 
  ...
  800451:	bb ee 11 80 00       	mov    $0x8011ee,%ebx
				p = "(null)";
			if (width > 0 && padc != '-')
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800b58:	c7 04 24 28 14 80 00 	movl   $0x801428,(%esp)
  ...
  800b89:	00 
  800b8a:	c7 44 24 08 54 14 80 	movl   $0x801454,0x8(%esp)
  800b91:	00 
  800b92:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b99:	00 
  800b9a:	c7 04 24 71 14 80 00 	movl   $0x801471,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800be6:	00 
  800be7:	c7 44 24 08 54 14 80 	movl   $0x801454,0x8(%esp)
  800bee:	00 
  800bef:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bf6:	00 
  800bf7:	c7 04 24 71 14 80 00 	movl   $0x801471,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c7c:	00 
  800c7d:	c7 44 24 08 54 14 80 	movl   $0x801454,0x8(%esp)
  800c84:	00 
  800c85:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c8c:	00 
  800c8d:	c7 04 24 71 14 80 00 	movl   $0x801471,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cda:	00 
  800cdb:	c7 44 24 08 54 14 80 	movl   $0x801454,0x8(%esp)
  800ce2:	00 
  800ce3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cea:	00 
  800ceb:	c7 04 24 71 14 80 00 	movl   $0x801471,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d38:	00 
  800d39:	c7 44 24 08 54 14 80 	movl   $0x801454,0x8(%esp)
  800d40:	00 
  800d41:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d48:	00 
  800d49:	c7 04 24 71 14 80 00 	movl   $0x801471,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d97:	00 
  800d98:	c7 44 24 08 54 14 80 	movl   $0x801454,0x8(%esp)
  800d9f:	00 
  800da0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800da7:	00 
  800da8:	c7 04 24 71 14 80 00 	movl   $0x801471,(%esp)
...
sys_env_destroy(envid_t envid)
{
  ...
  800e5c:	00 
  800e5d:	c7 44 24 08 54 14 80 	movl   $0x801454,0x8(%esp)
  800e64:	00 
  800e65:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e6c:	00 
  800e6d:	c7 04 24 71 14 80 00 	movl   $0x801471,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  800ee8:	c7 04 24 80 14 80 00 	movl   $0x801480,(%esp)
  ...
  800efe:	e8 b5 f1 ff ff       	call   8000b8 <vcprintf>
	cprintf("\n");
  800f03:	c7 04 24 a4 14 80 00 	movl   $0x8014a4,(%esp)
