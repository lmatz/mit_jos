...
libmain(int argc, char **argv)
{
  ...
  80004e:	e8 32 03 00 00       	call   800385 <sys_getenvid>
...
exit(void)
{
  ...
  800099:	e8 1b 03 00 00       	call   8003b9 <sys_env_destroy>
}
  80009e:	c9                   	leave  
  80009f:	c3                   	ret    
...
008000d3 <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8000d6:	83 ec 38             	sub    $0x38,%esp
  8000d9:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8000dc:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8000df:	89 7d fc             	mov    %edi,-0x4(%ebp)
	if (upcall==NULL) {
  8000e2:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
  8000e6:	75 0c                	jne    8000f4 <sys_env_set_pgfault_upcall+0x21>
		cprintf("lib sys_env_set_pgfault_up: upcall is NULL\n");
  8000e8:	c7 04 24 8c 11 80 00 	movl   $0x80118c,(%esp)
  8000ef:	e8 11 04 00 00       	call   800505 <cprintf>
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
	...
	asm volatile("int %1\n"
  8000f4:	bb 00 00 00 00       	mov    $0x0,%ebx
  8000f9:	b8 09 00 00 00       	mov    $0x9,%eax
  8000fe:	8b 55 08             	mov    0x8(%ebp),%edx
  800101:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  800104:	89 df                	mov    %ebx,%edi
  800106:	89 de                	mov    %ebx,%esi
  ...
  80010c:	7e 28                	jle    800136 <sys_env_set_pgfault_upcall+0x63>
		panic("syscall %d returned %d (> 0)", num, ret);
  80010e:	89 44 24 10          	mov    %eax,0x10(%esp)
  800112:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  800119:	00 
  80011a:	c7 44 24 08 b8 11 80 	movl   $0x8011b8,0x8(%esp)
  800121:	00 
  800122:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800129:	00 
  80012a:	c7 04 24 d5 11 80 00 	movl   $0x8011d5,(%esp)
  800131:	e8 16 03 00 00       	call   80044c <_panic>
{
	if (upcall==NULL) {
		cprintf("lib sys_env_set_pgfault_up: upcall is NULL\n");
	}
...
sys_ipc_recv(void *dstva)
{
  ...
  800169:	7e 28                	jle    800193 <sys_ipc_recv+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  80016b:	89 44 24 10          	mov    %eax,0x10(%esp)
  80016f:	c7 44 24 0c 0c 00 00 	movl   $0xc,0xc(%esp)
  800176:	00 
  800177:	c7 44 24 08 b8 11 80 	movl   $0x8011b8,0x8(%esp)
  80017e:	00 
  80017f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800186:	00 
  800187:	c7 04 24 d5 11 80 00 	movl   $0x8011d5,(%esp)
  80018e:	e8 b9 02 00 00       	call   80044c <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8001b6:	b8 0b 00 00 00       	mov    $0xb,%eax
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8001c9:	8b 1c 24             	mov    (%esp),%ebx
  8001cc:	8b 74 24 04          	mov    0x4(%esp),%esi
  8001d0:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8001d4:	89 ec                	mov    %ebp,%esp
  8001d6:	5d                   	pop    %ebp
  8001d7:	c3                   	ret    

008001d8 <sys_env_set_status>:
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8001ec:	b8 08 00 00 00       	mov    $0x8,%eax
  ...
  8001ff:	7e 28                	jle    800229 <sys_env_set_status+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  800201:	89 44 24 10          	mov    %eax,0x10(%esp)
  800205:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  80020c:	00 
  80020d:	c7 44 24 08 b8 11 80 	movl   $0x8011b8,0x8(%esp)
  800214:	00 
  800215:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80021c:	00 
  80021d:	c7 04 24 d5 11 80 00 	movl   $0x8011d5,(%esp)
  800224:	e8 23 02 00 00       	call   80044c <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800229:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  80022c:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80022f:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800232:	89 ec                	mov    %ebp,%esp
  800234:	5d                   	pop    %ebp
  800235:	c3                   	ret    
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800239:	83 ec 38             	sub    $0x38,%esp
  80023c:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  80023f:	89 75 f8             	mov    %esi,-0x8(%ebp)
  ...
  80025d:	7e 28                	jle    800287 <sys_page_unmap+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  80025f:	89 44 24 10          	mov    %eax,0x10(%esp)
  800263:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  80026a:	00 
  80026b:	c7 44 24 08 b8 11 80 	movl   $0x8011b8,0x8(%esp)
  800272:	00 
  800273:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80027a:	00 
  80027b:	c7 04 24 d5 11 80 00 	movl   $0x8011d5,(%esp)
  800282:	e8 c5 01 00 00       	call   80044c <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800287:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  80028a:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80028d:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8002a0:	89 7d fc             	mov    %edi,-0x4(%ebp)
	...
	asm volatile("int %1\n"
  8002a3:	b8 05 00 00 00       	mov    $0x5,%eax
  ...
  8002bb:	7e 28                	jle    8002e5 <sys_page_map+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002bd:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002c1:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  8002c8:	00 
  8002c9:	c7 44 24 08 b8 11 80 	movl   $0x8011b8,0x8(%esp)
  8002d0:	00 
  8002d1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002d8:	00 
  8002d9:	c7 04 24 d5 11 80 00 	movl   $0x8011d5,(%esp)
  8002e0:	e8 67 01 00 00       	call   80044c <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80031a:	7e 28                	jle    800344 <sys_page_alloc+0x52>
		panic("syscall %d returned %d (> 0)", num, ret);
  80031c:	89 44 24 10          	mov    %eax,0x10(%esp)
  800320:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  800327:	00 
  800328:	c7 44 24 08 b8 11 80 	movl   $0x8011b8,0x8(%esp)
  80032f:	00 
  800330:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800337:	00 
  800338:	c7 04 24 d5 11 80 00 	movl   $0x8011d5,(%esp)
  80033f:	e8 08 01 00 00       	call   80044c <_panic>
...
sys_yield(void)
{
  ...
  800357:	89 1c 24             	mov    %ebx,(%esp)
  80035a:	89 74 24 04          	mov    %esi,0x4(%esp)
  80035e:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_getenvid(void)
{
  ...
  80038b:	89 1c 24             	mov    %ebx,(%esp)
  80038e:	89 74 24 04          	mov    %esi,0x4(%esp)
  800392:	89 7c 24 08          	mov    %edi,0x8(%esp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  80039b:	b8 02 00 00 00       	mov    $0x2,%eax
  8003a0:	89 d1                	mov    %edx,%ecx
  8003a2:	89 d3                	mov    %edx,%ebx
  8003a4:	89 d7                	mov    %edx,%edi
  8003a6:	89 d6                	mov    %edx,%esi
...
sys_getenvid(void)
{
  ...
  8003aa:	8b 1c 24             	mov    (%esp),%ebx
  8003ad:	8b 74 24 04          	mov    0x4(%esp),%esi
  8003b1:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8003b5:	89 ec                	mov    %ebp,%esp
  8003b7:	5d                   	pop    %ebp
  8003b8:	c3                   	ret    

008003b9 <sys_env_destroy>:
...
sys_env_destroy(envid_t envid)
{
  ...
  8003bc:	83 ec 38             	sub    $0x38,%esp
  8003bf:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8003c2:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8003c5:	89 7d fc             	mov    %edi,-0x4(%ebp)
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8003cd:	b8 03 00 00 00       	mov    $0x3,%eax
  8003d2:	8b 55 08             	mov    0x8(%ebp),%edx
  8003d5:	89 cb                	mov    %ecx,%ebx
  8003d7:	89 cf                	mov    %ecx,%edi
  8003d9:	89 ce                	mov    %ecx,%esi
  ...
  8003df:	7e 28                	jle    800409 <sys_env_destroy+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003e1:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003e5:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  8003ec:	00 
  8003ed:	c7 44 24 08 b8 11 80 	movl   $0x8011b8,0x8(%esp)
  8003f4:	00 
  8003f5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003fc:	00 
  8003fd:	c7 04 24 d5 11 80 00 	movl   $0x8011d5,(%esp)
  800404:	e8 43 00 00 00       	call   80044c <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  800409:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  80040c:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80040f:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800412:	89 ec                	mov    %ebp,%esp
  800414:	5d                   	pop    %ebp
  800415:	c3                   	ret    
...
sys_cgetc(void)
{
  ...
  80042c:	b8 01 00 00 00       	mov    $0x1,%eax
  800431:	89 d1                	mov    %edx,%ecx
  800433:	89 d3                	mov    %edx,%ebx
...
sys_cgetc(void)
{
  ...
  80043b:	8b 1c 24             	mov    (%esp),%ebx
  80043e:	8b 74 24 04          	mov    0x4(%esp),%esi
  800442:	8b 7c 24 08          	mov    0x8(%esp),%edi
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  80045d:	e8 23 ff ff ff       	call   800385 <sys_getenvid>
  ...
  800478:	c7 04 24 e4 11 80 00 	movl   $0x8011e4,(%esp)
  80047f:	e8 81 00 00 00       	call   800505 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800484:	89 74 24 04          	mov    %esi,0x4(%esp)
  800488:	8b 45 10             	mov    0x10(%ebp),%eax
  80048b:	89 04 24             	mov    %eax,(%esp)
  80048e:	e8 11 00 00 00       	call   8004a4 <vcprintf>
	cprintf("\n");
  800493:	c7 04 24 08 12 80 00 	movl   $0x801208,(%esp)
  80049a:	e8 66 00 00 00       	call   800505 <cprintf>
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8004a7:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct printbuf b;
  ...
  8004d9:	c7 04 24 1f 05 80 00 	movl   $0x80051f,(%esp)
  8004e0:	e8 ca 01 00 00       	call   8006af <vprintfmt>
	sys_cputs(b.buf, b.idx);
  8004e5:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  8004eb:	89 44 24 04          	mov    %eax,0x4(%esp)
  8004ef:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  8004f5:	89 04 24             	mov    %eax,(%esp)
  8004f8:	e8 a3 fb ff ff       	call   8000a0 <sys_cputs>
  ...
  80050b:	8d 45 0c             	lea    0xc(%ebp),%eax
{
	...
	va_start(ap, fmt);
	cnt = vcprintf(fmt, ap);
  80050e:	89 44 24 04          	mov    %eax,0x4(%esp)
  800512:	8b 45 08             	mov    0x8(%ebp),%eax
  800515:	89 04 24             	mov    %eax,(%esp)
  800518:	e8 87 ff ff ff       	call   8004a4 <vcprintf>
	va_end(ap);
...
putch(int ch, struct printbuf *b)
{
  ...
  80052e:	88 54 03 08          	mov    %dl,0x8(%ebx,%eax,1)
  800532:	83 c0 01             	add    $0x1,%eax
  800535:	89 03                	mov    %eax,(%ebx)
	if (b->idx == 256-1) {
  800537:	3d ff 00 00 00       	cmp    $0xff,%eax
  80053c:	75 19                	jne    800557 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  80053e:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  800545:	00 
  800546:	8d 43 08             	lea    0x8(%ebx),%eax
  800549:	89 04 24             	mov    %eax,(%esp)
  80054c:	e8 4f fb ff ff       	call   8000a0 <sys_cputs>
		b->idx = 0;
  800551:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
  800557:	83 43 04 01          	addl   $0x1,0x4(%ebx)
}
  80055b:	83 c4 14             	add    $0x14,%esp
  80055e:	5b                   	pop    %ebx
  80055f:	5d                   	pop    %ebp
  800560:	c3                   	ret    
	...
