...
//	DEBUG("Before Check page alloc!\n");
	check_page_alloc();
//	DEBUG("Before Check page!\n");
	check_page();
...
//		boot_map_region(kern_pgdir, cur - KSTKSIZE - KSTKGAP, KSTKGAP, ~0,0);
	}	
}
...
page_insert(pde_t *pgdir, struct PageInfo *pp, void *va, int perm)
{
	...
	if ( pte ){
		...
		DEBUG("page_insert: after page_remove\n");
	}
	else {
		return -E_NO_MEM;
	}	
