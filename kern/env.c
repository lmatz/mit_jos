...
//	memcpy(e->env_pgdir,kern_pgdir,PGSIZE);	
	...
	ENVDEBUG("end with env_setup_vm\n");	
...
load_icode(struct Env *e, uint8_t *binary)
{
	...
	//  You should only load segments with ph->p_type == _PROG_LOAD.
	...
	ENVDEBUG("load_icode end with for loop\n");
